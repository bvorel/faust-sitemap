...
const createNotFound = (ctx, revalidate) => (Object.assign({ notFound: true }, (!isSSR(ctx) && { revalidate: revalidate !== null && revalidate !== void 0 ? revalidate : exports.DEFAULT_ISR_REVALIDATE })));
