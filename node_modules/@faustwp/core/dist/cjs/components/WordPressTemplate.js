...
const isWordPressPreview_js_1 = require("../utils/isWordPressPreview.js");
...
function WordPressTemplate(props) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        setIsPreview((0, isWordPressPreview_js_1.isWordPressPreview)(window.location.search));
    }, []);
    /**
    ...
    , Object.assign({}, props, { seedNode: seedNode, isPreview: isPreview === true, isAuthenticated: isAuthenticated === true, loading: loading, setLoading: setLoading })));
}
