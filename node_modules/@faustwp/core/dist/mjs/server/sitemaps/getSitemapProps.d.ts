 ...
 */
export declare const SITEMAP_INDEX_PATH = "/sitemap.xml";
/**
 ...
 */
export declare function validateConfig(config: Partial<GetSitemapPropsConfig>): void;
export declare function getSitemapProps(ctx: GetServerSidePropsContext, config: GetSitemapPropsConfig): Promise<{
    notFound: boolean;
    props?: undefined;
} | {
    props: {};
