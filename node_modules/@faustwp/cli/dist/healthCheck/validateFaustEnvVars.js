...
export function isWPEngineComSubdomain(url) {
...
export const validateFaustEnvVars = async () => {
    ...
    if (isWPEngineComSubdomain(process.env.NEXT_PUBLIC_WORDPRESS_URL)) {
        ...
        infoLog(`Ex: https://example.wpengine.com -> https://example.wpenginepowered.com`);
        infoLog(`This will leverage WP Engine's Advanced Network CDN. See: https://wpengine.com/support/network/`);
    }
    if (!secretWp) {
    ...
    if (secretWp) {
        ...
        try {
            ...
            if (response.status === 401) {
                ...
                errorLog('Ensure your FAUST_SECRET_KEY environment variable matches your Secret Key in the Faust WordPress plugin settings');
                process.exit(1);
            }
