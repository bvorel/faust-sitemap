 ...
 */
export function parsePhpAssetFile(phpContent) {
    const jsonObject = {};
 ...
 */
export async function processBlockFiles(files) {
 ...
 * @returns {Promise<void>}
 */
export async function uploadToWordPress(zipPath) {
    ...
    const headers = Object.assign(Object.assign({}, form.getHeaders()), { 'x-faustwp-secret': getWpSecret() || '' });
    try {
